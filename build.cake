...
var solutionToBuild = "./source/Octopus.Server.Extensibility.Core.sln";
var fileToPublish = "./source/Octopus.Server.Extensibility.Core/bin/Release/Octopus.Server.Extensibility.Core.dll";
...
Setup(context =>
{
    ...
    Information("Building Octopus.Server.Extensibility.Core v{0}", nugetVersion);
});
...
Task("__Pack")
    .Does(() => {
        ...
        var nuspecFile = "Octopus.Server.Extensibility.Core.nuspec";
...
Task("__Publish")
    ...
    .Does(() =>
{
    NuGetPush($"{artifactsDir}/Octopus.Server.Extensibility.Core.{nugetVersion}.nupkg", new NuGetPushSettings {
    ...
    .Does(() =>
{
    ...
    CopyFileToDirectory(Path.Combine(artifactsDir, $"Octopus.Server.Extensibility.Core.{nugetVersion}.nupkg"), localPackagesDir);
});
