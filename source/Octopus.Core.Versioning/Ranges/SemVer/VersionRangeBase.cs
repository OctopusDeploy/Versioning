...
namespace Octopus.Core.Versioning.Ranges.SemVer
{
    ...
    public abstract class VersionRangeBase : IEquatable<VersionRangeBase>
    {
        ...
        private readonly SemanticVersion _maxVersion;
        ...
        public VersionRangeBase(SemanticVersion minVersion = null, bool includeMinVersion = true, SemanticVersion maxVersion = null,
        ...
        /// <returns>True if the given version meets the version requirements.</returns>
        public bool Satisfies(SemanticVersion version, VersionComparison versionComparison)
        {
        ...
        /// <returns>True if the given version meets the version requirements.</returns>
        public bool Satisfies(SemanticVersion version, IVersionComparer comparer)
        {
            if (version == null)
            {
