...
{
    public static class SemanticVersionUtils
    {
        ...
        /// </summary>
        public static string GetLegacyString(Version version, IEnumerable<string> releaseLabels, string metadata)
        {
        ...
        public static Version NormalizeVersionValue(Version version)
        {
        ...
        /// </summary>
        public static Tuple<string, string[], string> ParseSections(string value)
        {
        ...
        public static bool IsValid(string s, bool allowLeadingZeros)
        {
            return s.Split('.').All(p => IsValidPart(p, allowLeadingZeros));
        }

        public static bool IsValidPart(string s, bool allowLeadingZeros)
        {
            return IsValidPart(s.ToCharArray(), allowLeadingZeros);
        }

        public static bool IsValidPart(char[] chars, bool allowLeadingZeros)
        {
            var result = true;
        ...
        public static bool IsLetterOrDigitOrDash(char c)
        {
            var x = (int)c;
