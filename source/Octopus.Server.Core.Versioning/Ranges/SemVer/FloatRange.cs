// This class is based on NuGet's FloatRange class from https://github.com/NuGetArchive/NuGet.Versioning
...
namespace Octopus.Core.Versioning.Ranges.SemVer
{
    ...
    {
        private readonly SemanticVersion _minVersion;
        ...
        public FloatRange(NuGetVersionFloatBehavior floatBehavior, SemanticVersion minVersion)
        ...
        public FloatRange(NuGetVersionFloatBehavior floatBehavior, SemanticVersion minVersion, string releasePrefix)
        {
        ...
        public static bool TryParse(string versionString, out FloatRange range)
        {
            ...
            if (versionString != null)
            {
                ...
                {
                    range = new FloatRange(NuGetVersionFloatBehavior.Major, new SemanticVersion(new Version(0, 0)));
                }
                else if (starPos == versionString.Length - 1)
                {
                    ...
                    if (SemVerFactory.TryCreateVersion(actualVersion, out version))
                    {
                ...
                else
                {
                    ...
                    SemanticVersion version = null;
                    if (SemVerFactory.TryCreateVersion(versionString, out version))
                    {
                        // there is no float range for this version
