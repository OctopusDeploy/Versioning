...
namespace Octopus.Core.Versioning.Ranges.SemVer
{
    ...
    public partial class VersionRange : VersionRangeBase, IFormattable
    {
        ...
        public VersionRange(SemanticVersion minVersion)
        ...
        /// </summary>
        /// <param name="minVersion">Lower bound of the version range.</param>
        public VersionRange(SemanticVersion minVersion, FloatRange floatRange)
        ...
        public VersionRange(SemanticVersion minVersion = null, bool includeMinVersion = true, SemanticVersion maxVersion = null,
        ...
        /// </summary>
        public SemanticVersion FindBestMatch(IEnumerable<SemanticVersion> versions)
        {
            SemanticVersion bestMatch = null;
        ...
        /// </summary>
        public bool IsBetter(SemanticVersion current, SemanticVersion considering)
        {
