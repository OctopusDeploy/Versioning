...
namespace Octopus.Core.Resources.Metadata
{
    public class MetadataFactory : IMetadataFactory
    {
        ...
        public bool CanGetMetadataFromPackageID(string packageID, out BasePackageMetadata metadata, VersionFormat versionFormat)
        {
            return versionFormat == VersionFormat.Maven
        ...
        public Maybe<PackageMetadata> CanGetMetadataFromPackageName(string packageFile, VersionFormat versionFormat)
        {
            return versionFormat == VersionFormat.Maven
        ...
        public Maybe<PackageMetadata> CanGetMetadataFromServerPackageName(string packageFile, VersionFormat versionFormat)
        {
            return versionFormat == VersionFormat.Maven
