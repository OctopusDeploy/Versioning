...
namespace Octopus.Core.Versioning.Semver
{
    ...
    public class SemanticVersion : StrictSemanticVersion
    {
        ...
        public SemanticVersion(Version version, string releaseLabel = null, string metadata = null)
            : this(version,
                SemanticVersionUtils.ParseReleaseLabels(releaseLabel), 
                metadata,
                SemanticVersionUtils.GetLegacyString(version, SemanticVersionUtils.ParseReleaseLabels(releaseLabel), metadata))
        {
        }
        ...
        public SemanticVersion(int major, int minor, int patch, string releaseLabel)
            : this(major, minor, patch, SemanticVersionUtils.ParseReleaseLabels(releaseLabel), null)
        {
        }
        ...
        public SemanticVersion(int major, int minor, int patch, string releaseLabel, string metadata)
            : this(major, minor, patch, SemanticVersionUtils.ParseReleaseLabels(releaseLabel), metadata)
        {
        }
        ...
        public SemanticVersion(int major, int minor, int patch, int revision, string releaseLabel, string metadata)
            : this(major, minor, patch, revision, SemanticVersionUtils.ParseReleaseLabels(releaseLabel), metadata)
        {
        }
