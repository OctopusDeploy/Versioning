    ...
    public static class SemVerFactory
    {
        ...
        public static bool TryCreateVersion(string value, out SemanticVersion version, bool preserveMissingComponents = false)
        {
            ...
            if (value != null)
            {
                ...
                var sections = SemanticVersionUtils.ParseSections(value.Trim());
                    ...
                    && !string.IsNullOrEmpty(sections.Item1))
                {
                    ...
                    if (Version.TryParse(versionPart, out systemVersion))
                    {
                        ...
                        if (sections.Item2 != null
                            && !sections.Item2.All(s => SemanticVersionUtils.IsValidPart(s, true)))
                        {
                            return false;
                        }
                        ...
                        var ver = preserveMissingComponents
                            ? systemVersion
                            : SemanticVersionUtils.NormalizeVersionValue(systemVersion);
