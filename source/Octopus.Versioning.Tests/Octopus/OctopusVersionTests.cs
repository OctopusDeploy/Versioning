...
namespace Octopus.Versioning.Tests.Versions.Octopus
{
    ...
    public class OctopusVersionTests
    {
        ...
        [TestCase("2.0.0-rc.1+build.123", 2, 0, 0, "rc.1", "rc", "1", "build.123")]
        ...
        [TestCase("1.0.0+0.build.1-rc.10000aaa-kk-0.1", 1, 0, 0, "", "", "", "0.build.1-rc.10000aaa-kk-0.1")]
        [TestCase("99999999.99999999.99999999", 99999999, 99999999, 99999999, 0, "", "", "", "")]
        [TestCase("1.0.0-0A.is.legal", 1, 0, 0, 0, "A.is.legal", "0A", "is.legal", "")]
